...
// GET /api/users/[address]/subscriptions - Get user's subscriptions
export async function GET(
  ...
  try {
    ...
    const result = await subscriptionService.getUserSubscriptions(userId, { page, limit })
    
    return NextResponse.json(result)
  } catch (error) {
    console.error('Error in GET /api/users/[address]/subscriptions:', error)
