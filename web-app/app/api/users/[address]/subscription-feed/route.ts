...
// GET /api/users/[address]/subscription-feed - Get videos from subscribed creators
export async function GET(
  ...
  try {
    ...
    const result = await subscriptionService.getSubscriptionFeed(userId, { page, limit })
    
    return NextResponse.json(result)
  } catch (error) {
    console.error('Error in GET /api/users/[address]/subscription-feed:', error)
