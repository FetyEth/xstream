...
import VideoPlayerWithStake from "@/components/VideoPlayerWithStake";
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Video Player */}
            <VideoPlayerWithStake video={{
              id: video.id,
              title: video.title,
              duration: video.duration || 0,
              pricePerSecond: video.pricePerSecond || 0,
              creatorWallet: video.creatorWallet || video.creator?.walletAddress || '',
            }} />
